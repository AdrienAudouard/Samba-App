...
class WifiTestScreen extends React.Component {
    constructor(props) {
        super(props);
    ...
    componentDidMount(): void {
        DeviceProvider.addWifiStateChangeListener((value) => {
           if (value) {
                ...
                <SafeAreaView style={styles.container}>
                    <View style={styles.viewContainer}>
                        <Text h4 style={styles.textCenter}>
                            Please turn the Wifi on !
                        </Text>
                        <Image
                            style={{width: 100, height: 100}}
                            source={require('../../../assets/wifi-signal.png')}
                        />
                        <Button
                            buttonStyle={styles.myDeviceButton}
                            title="Turn on the Wifi !"
                            onPress={() => DeviceProvider.turnOnWifi()}
                        />

                        <Button
                            buttonStyle={styles.noButton}
                            title="I can't turn on my Wifi"
    ...
    componentWillUnmount(): void {
        ...
        DeviceProvider.removeWifiStateChangeListener();
    }
}
